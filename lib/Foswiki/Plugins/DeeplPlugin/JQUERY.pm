...
#
# BookPlugin is Copyright (C) 2021-2024 Michael Daum http://michaeldaumconsulting.com
#
...
package Foswiki::Plugins::DeeplPlugin::JQUERY;

use strict;
use warnings;

use Foswiki::Plugins ();
use Foswiki::Plugins::DeeplPlugin();
